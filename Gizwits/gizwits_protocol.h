...
* @{
*/
#define PRODUCT_KEY "14a65c0070f3441780837248fa591809"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "5b710fa1d9df46d686608e98e6732cc0"
...
*/
#define Iock_LEN                           1
#define Latitudinal_direction_LEN                           1
#define Direction_of_longitude_LEN                           1
#define FS_LEN                           2

#define numSv_RATIO                         1
#define numSv_ADDITION                      0
#define numSv_MIN                           0
#define numSv_MAX                           24
#define numSv_LEN                           1
#define DiffAge_RATIO                         1
#define DiffAge_ADDITION                      0
#define DiffAge_MIN                           0
#define DiffAge_MAX                           99
#define DiffAge_LEN                           1
#define DiffSta_ID_RATIO                         1
#define DiffSta_ID_ADDITION                      0
#define DiffSta_ID_MIN                           0
#define DiffSta_ID_MAX                           100
#define DiffSta_ID_LEN                           1
#define HDOP_RATIO                         0.1
#define HDOP_ADDITION                      0
#define HDOP_MIN                           0
#define HDOP_MAX                           990
#define HDOP_LEN                           2
#define Sep_RATIO                         1
#define Sep_ADDITION                      0
#define Sep_MIN                           0
#define Sep_MAX                           1000
#define Sep_LEN                           2
#define time_RATIO                         0.001
#define time_ADDITION                      0
#define time_MIN                           0
#define time_MAX                           235959000
#define time_LEN                           4
#define latitude_RATIO                         0.0001
#define latitude_ADDITION                      0
#define latitude_MIN                           0
#define latitude_MAX                           99990000
#define latitude_LEN                           4
#define Direction_RATIO                         0.0001
#define Direction_ADDITION                      0
#define Direction_MIN                           0
#define Direction_MAX                           999990000
#define Direction_LEN                           4
#define Msl_RATIO                         0.01
#define Msl_ADDITION                      -155
#define Msl_MIN                           0
#define Msl_MAX                           899900
#define Msl_LEN                           4
#define data_RATIO                         1
#define data_ADDITION                      0
#define data_MIN                           0
#define data_MAX                           99999999
#define data_LEN                           4
...
typedef enum
{
    Latitudinal_direction_VALUE0 = 0,//南
    Latitudinal_direction_VALUE1 = 1,//北
    Latitudinal_direction_VALUE_MAX,
} Latitudinal_direction_ENUM_T;
typedef enum
{
    Direction_of_longitude_VALUE0 = 0,//东
    Direction_of_longitude_VALUE1 = 1,//西
    Direction_of_longitude_VALUE_MAX,
} Direction_of_longitude_ENUM_T;
typedef enum
{
    FS_VALUE0 = 0,//定位不可用
    FS_VALUE1 = 1,//定位模式
...
typedef struct {
  bool valueIock;
  uint32_t valueLatitudinal_direction;
  uint32_t valueDirection_of_longitude;
  uint32_t valueFS;
  uint32_t valuenumSv;
  uint32_t valueDiffAge;
  uint32_t valueDiffSta_ID;
  float valueHDOP;
  uint32_t valueSep;
  float valuetime;
  float valuelatitude;
...
typedef struct {
  uint8_t flagIock:1;
  uint8_t flagLatitudinal_direction:1;
  uint8_t flagDirection_of_longitude:1;
  uint8_t flagFS:1;
  uint8_t flagnumSv:1;
  uint8_t flagDiffAge:1;
  uint8_t flagDiffSta_ID:1;
  uint8_t flagHDOP:1;
  uint8_t flagSep:1;
  uint8_t flagtime:1;
...
typedef struct {
  ...
  uint8_t valuenumSv;
  uint8_t valueDiffAge;
  uint8_t valueDiffSta_ID;
  uint16_t valueHDOP;
  uint16_t valueSep;
  uint32_t valuetime;
  uint32_t valuelatitude;
  uint32_t valueDirection;
  uint32_t valueMsl;
  uint32_t valuedata;
} devStatus_t;
